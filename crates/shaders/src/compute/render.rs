...
fn color_stone(vx: i32, vy: i32, vz: i32) -> Vec3 {
...
fn color_water(vx: i32, vy: i32, _vz: i32, grid_size: u32) -> Vec3 {
...
fn color_lava(vx: i32, vy: i32, vz: i32) -> Vec3 {
...
fn color_wood(vx: i32, vy: i32, vz: i32) -> Vec3 {
...
fn color_ash(vx: i32, vy: i32, vz: i32) -> Vec3 {
    let h = hash3(vx, vy, vz);
...
fn color_ice(vx: i32, vy: i32, vz: i32) -> Vec3 {
...
fn color_gunpowder(vx: i32, vy: i32, vz: i32) -> Vec3 {
    let h = hash3(vx, vy, vz);
...
///
/// Each material dispatches to a separate helper function to avoid long if/else
/// chains that rust-gpu may drop during SPIR-V compilation (see issue #125).
/// Returns (r, g, b) as floats in [0, 1].
fn textured_material_color(material_id: u32, vx: i32, vy: i32, vz: i32, grid_size: u32) -> Vec3 {
    match material_id {
        0 => color_stone(vx, vy, vz),
        1 => color_water(vx, vy, vz, grid_size),
        2 => color_lava(vx, vy, vz),
        3 => color_wood(vx, vy, vz),
        4 => color_ash(vx, vy, vz),
        5 => color_ice(vx, vy, vz),
        6 => color_gunpowder(vx, vy, vz),
        _ => Vec3::new(1.0, 0.0, 1.0), // magenta = unknown material
    }
}
